...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("EventSchedule");
...
//        });
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<EventSchedule, EventScheduleViewHolder> FBRA = new FirebaseRecyclerAdapter<EventSchedule, EventScheduleViewHolder>(
                EventSchedule.class,
                R.layout.card_items,
                EventScheduleViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(EventScheduleViewHolder viewHolder, EventSchedule model, int position) {
    ...
    public static class EventScheduleViewHolder extends RecyclerView.ViewHolder{
        View mView;
        public EventScheduleViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
        }
